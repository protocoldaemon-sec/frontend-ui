...
export function SecurityAnalysis() {
  ...
  return (
    <>
      {/* Original container without the input section */}
      ...
      {/* Fixed file input at the bottom of the page */}
      <div className="fixed bottom-4 left-0 right-0 flex justify-center">
        <div className="w-full max-w-4xl mx-4s rounded-lg">
          <div className="bg-slate-800/50 rounded-lg p-6 m-1">
